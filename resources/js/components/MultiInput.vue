<template>
    <div class="form-group">
        ...
        <multiselect v-model="value" :tag-placeholder="placeholder" :placeholder="placeholder" label="name" track-by="id" :options="options" :multiple="true" :taggable="true" @tag="addTag"></multiselect>
...
<script>
    ...
    export default {
        ...
        mounted() {
            console.log('Component multi selected.');
