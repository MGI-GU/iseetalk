                                                ...
                                                <div class="row">
                                                    <div class="col-lg-7 col-md-8 col-sm-8 col-xs-8">
                                                        <ul id="myTabedu1" class="tab-review-design" >
                                                            ...
                                                            <li class="{{request()->has('subscription') ? 'active':'1'}}"><a href="{{route('studio.channel.edit', [$data->slug])}}?subscription=1"><small>Subscriber </small></a></li>
                                                            @if($data->visibility=='private')
                                                            <li class="{{request()->has('request') ? 'active':'1'}}"><a href="{{route('studio.channel.edit', [$data->slug])}}?request=1"><small>Request </small></a></li>
                                                            @endif
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-5 col-md-4 col-sm-4 col-xs-4 text-right">
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="row">
                                                                    @if($subscribe->count()>0)
                                                                        ...
                                                                        <div class="col-lg-2 col-md-2 col-sm-3 col-xs-6 video-list-vertical box">
                                                                            <div>
                                                                                <div class="courses-title" style="height: 100px;">
                                                                                    <img style="height: 100px;" src="{{$user->subscriber->picture}}" alt="">
                                                                                </div>
                                                                                ...
                                                                                <div class="courses-alaltic">
                                                                                    @if(request()->has('request'))
                                                                                        <a href="{{route('studio.channel.update.subscriber', [$data->slug, 'subscriber_id'=>$user->id, 'type'=>'confirm'])}}" class="btn btn-success">Confirm</a>
                                                                                    @endif
                                                                                    <a href="{{route('studio.channel.update.subscriber', [$data->slug, 'subscriber_id'=>$user->id, 'type'=>'delete'])}}" class="btn btn-default">Delete</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        @endforeach
                                                                    @else
                                                                    <p class="text-center">Channel ini belum memiliki subscriber</p>
                                                                    @endif
                                                                </div>
                                                            </div>
                                                        </div>
